...
export const FiltroModular: React.FC<FiltroModularProps> = ({
  ...
  const columnaSeleccionada = columnas.find(col => col.nombre === filtro.columna);
  const operadoresDisponibles = columnaSeleccionada ? obtenerOperadores(columnaSeleccionada.tipo) : [];
          ...
          return (
            <div className="flex gap-2">
              <input
                ...
                onChange={(e) => actualizarFiltro('valor', { 
                  ...filtro.valor, 
    ...
    <div className="p-3 bg-white border rounded-lg">
      ...
      {showLogicSelector && index > 0 && onLogicChange && (
        <div className="flex items-center mb-3">
          ...
          <select
            value={filtro.logica}
            onChange={(e) => onLogicChange(filtro.id, e.target.value as 'AND' | 'OR')}
